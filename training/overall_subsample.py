...
data_list = []
for file in glob.glob("/storage/home/hcoda1/0/ssahoo41/data/testflight_data/SPARC_test_mcsh/results_folder/training_results/system_subsampled_files_0.1/*.pickle"): #all the files in the subsampled folder 
